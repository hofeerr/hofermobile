...
import com.example.apppost22.viewModel.PostViewModel
    ...
    Column(modifier = Modifier.padding(16.dp)){
        ...
        Button(
            ...
            colors = ButtonDefaults.buttonColors(
                containerColor = Color(0xFFFF69B4) // Rosa Pink Barbie
            )
        ) {
            Text(text = "Criar Usuário", color = Color.White) // Ajusta o texto para branco
        }
